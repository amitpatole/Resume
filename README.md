...
experience optimizing infrastructure, streamlining CI/CD pipelines, and 
architecting robust cloud solutions. Proven track record of implementing 
...
Highlights:
At Viavi Solutions, I've been at the forefront of telecommunications technology,
leading critical projects in 5G and beyond. My role has been pivotal in
implementing VMWARE Telco Cloud Automation for ORAN development, showcasing our
solutions at Mobile World Congress. I've significantly improved deployment
efficiency and reduced costs through innovative cloud migrations and automation
strategies, directly impacting the company's position as a leader in the
telecom industry.

Global Deployments Team (May 2020 - October 2023):
- Migrated on-premises GeoLocation and Geo Intelligence software to Azure for AT&T
- Developed automated pipelines using Git and Azure DevOps, reducing update time by 70%
- Automated software installation and upgrades, increasing deployment efficiency by 85%
- Implemented VMWARE Telco Cloud Automation for ORAN software development
- Set up showcase environment for Mobile World Congress, featuring key Viavi products

AIOPS/DEVSECOPS Team (November 2023 - Present):
- Created build pipelines for Protean Solutions Development and AIOPS/Cango
- Developed automation for AIOPS team to update app and chart versions
...
amit@devops:~$ cat contact_info.json
{
